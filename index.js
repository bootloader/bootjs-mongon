...
const { QueryBuilder, database, databaseRo, throwError, dbConfig} = require('./mongon');
...
const getTenantDB = ({ dbDomain, domain, dbPrefix,dbName, db, collectionName, schema}, databaseFn = database) => {
...
const primaryApi = createApi(database);
const readonlyApi = createApi(databaseRo);
